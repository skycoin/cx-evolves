...
// Composites_V1 for evolve with composites numbers, 1 i32 input, 1 i32 output
func Composites_V1(ind *cxast.CXProgram, solPrototype EvolveSolProto, cfg TaskConfig) (float64, error) {
	var points int64 = 0
